            ...
            <div class="widget-header"> <i class="icon-th-list"></i>
             ...
             <!-- widget-busca -->
						...
						<div class="control-group">	
							<div class="controls">
								...
								<select name="codigo_instituto" id="codigo_instituto" class="span3" placeholder="Instituto">
									...
									<option value="<?php echo $resultado_consulta_instituto["codigo_instituto"];?>"><?php echo mb_convert_encoding($resultado_consulta_instituto["nome_instituto"],'UTF-8');?></option>
									<?php }?>
								</select>
                ...
                <select name="codigo_tema_curso" id="codigo_tema_curso" class="span3" placeholder="Tema">
									...
									<option value="<?php echo $resultado_consulta_situacao["codigo_tema_curso"];?>"><?php echo mb_convert_encoding($resultado_consulta_situacao["descricao_tema_curso"],'UTF-8');?></option>
									<?php }?>
								</select>
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <?php echo mb_convert_encoding($resultado_consulta_cursos["nome_curso"],'UTF-8');?> </td>
                    <td> <?php echo mb_convert_encoding($resultado_consulta_cursos["descricao_tema_curso"],'UTF-8');?> </td>
                    <td> <?php echo mb_convert_encoding($resultado_consulta_cursos["nome_instituto"],'UTF-8');?> </td>
