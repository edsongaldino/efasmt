            ...
            <div class="widget-header"> <i class="icon-th-list"></i>
             ...
             <!-- widget-busca -->
						...
						<div class="control-group">	
							<div class="controls">
								...
								<select name="codigo_instituto" id="codigo_instituto" class="span3" placeholder="Instituto">
									...
									<option value="<?php echo $resultado_consulta_instituto["codigo_instituto"];?>"><?php echo utf8_decode($resultado_consulta_instituto["nome_instituto"]);?></option>
									<?php }?>
								</select>
                ...
                <select name="codigo_tema_curso" id="codigo_tema_curso" class="span3" placeholder="Tema">
									...
									<option value="<?php echo $resultado_consulta_situacao["codigo_tema_curso"];?>"><?php echo utf8_decode($resultado_consulta_situacao["descricao_tema_curso"]);?></option>
									<?php }?>
								</select>
