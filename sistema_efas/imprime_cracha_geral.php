...
<style>
.dados_cracha{width:10cm; height:3cm; float:left; margin-top:9cm; margin-left:-0.7cm; }
...
while($resultado_consulta_dados_cracha = mysql_fetch_assoc($query_consulta_dados_cracha)){
