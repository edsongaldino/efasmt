...
function calcula_total_inscritos_curso($codigo_curso) {
	...
	$sql_consulta = "SELECT participante_evento_curso.codigo_participante FROM participante_evento_curso WHERE participante_evento_curso.codigo_evento = '10' AND participante_evento_curso.codigo_curso = '".$codigo_curso."'";
